        ...
        <div class="text-center sm:text-left">
          ...
          <nav aria-label="Footer About Nav" class="mt-8">
            <ul class="space-y-4 text-sm">
              <li>
                <a class="text-gray-700 transition hover:text-blue-700" href="/">
                  Company History
                </a>
              </li>
              ...
              <li>
                <a class="group flex justify-center gap-1.5 sm:justify-start" href="/">
                  ...
                  <span class="relative flex h-2 w-2">
                    <span
                      class="absolute inline-flex h-full w-full animate-ping rounded-full bg-pink-400 opacity-75"></span>
      ...
      <div class="mt-16">
        ...
        <div class="mt-16 sm:flex sm:items-center sm:justify-between">
          <div class="flex justify-center text-teal-600 sm:justify-start">
            <img src="../../../img/logoAsset1@4x.png" alt="Logo" class="w-40">
          </div>
