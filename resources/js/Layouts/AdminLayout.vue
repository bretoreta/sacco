            ...
            <nav class="bg-white border-b-2 shadow border-gray-200 fixed w-full top-0 z-50">
                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                                ...
                                <NavLink :href="route('admin.loans.index')" :active="route().current('admin.loans.*')">
                                    Loans
                                </NavLink>
                                <NavLink :href="route('admin.loan.types.index')" :active="route().current('admin.loan.types.*')">
                                    Loan Types
                                </NavLink>
                            </div>
                        </div>
                ...
                <div :class="{'block': showingNavigationDropdown, 'hidden': ! showingNavigationDropdown}" class="sm:hidden">
                    <div class="pt-2 pb-3 space-y-1">
                        <ResponsiveNavLink :href="route('admin.dashboard.index')" :active="route().current('admin.dashboard.index')">
                            Dashboard
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('admin.loan.types.index')" :active="route().current('admin.loan.types.*')">
                            Loan Types
                        </ResponsiveNavLink>
                    </div>
