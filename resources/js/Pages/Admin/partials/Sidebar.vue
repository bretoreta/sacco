			...
			<div class="space-y-8">
				...
				<div>
					...
					<ul class="mt-3">
							...
							<div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
								<ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
									...
									<Link :href="route('admin.members.create')"
										class="mb-1 last:mb-0 block text-slate-400 hover:text-slate-200 transition duration-150 truncate"
										:class="(route().current('admin.members.create')) && '!text-teal-300'">
									<span
										class="text-sm font-light lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Add Member</span>
									</Link>
									<Link :href="route('admin.members.manage')"
										class="mb-1 last:mb-0 block text-slate-400 hover:text-slate-200 transition duration-150 truncate"
										:class="(route().current('admin.members.manage')) && '!text-teal-300'">
									<span
						...
						<SidebarLinkGroup v-slot="parentLink" :activeCondition="route().current('admin.meetings.*')">
							...
							<div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
								<ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
									...
									<Link :href="route('admin.meetings.manage')"
										class="mb-1 last:mb-0 block text-slate-400 hover:text-slate-200 transition duration-150 truncate"
										:class="(route().current('admin.meetings.manage')) && '!text-teal-300'">
									<span
						...
						<!-- Legal Docs -->
						<SidebarLinkGroup v-slot="parentLink" :activeCondition="route().current('admin.docs.*')">
							<a class="block text-slate-200 hover:text-white truncate transition duration-200 py-2"
								:class="(route().current('admin.docs.*')) && 'hover:text-white'" href="#0"
								@click.prevent="sidebarExpanded ? parentLink.handleClick() : sidebarExpanded = true">
								<div class="flex items-center justify-between">
									<div class="flex items-center">
										<svg xmlns="http://www.w3.org/2000/svg" :fill="route().current('admin.docs.*') ? 'rgb(94 234 212)' : 'none'" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
											<path :class="(route().current('admin.docs.*')) && '!text-teal-300'" stroke-linecap="round" stroke-linejoin="round" d="M12 3v17.25m0 0c-1.472 0-2.882.265-4.185.75M12 20.25c1.472 0 2.882.265 4.185.75M18.75 4.97A48.416 48.416 0 0012 4.5c-2.291 0-4.545.16-6.75.47m13.5 0c1.01.143 2.01.317 3 .52m-3-.52l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.988 5.988 0 01-2.031.352 5.988 5.988 0 01-2.031-.352c-.483-.174-.711-.703-.59-1.202L18.75 4.971zm-16.5.52c.99-.203 1.99-.377 3-.52m0 0l2.62 10.726c.122.499-.106 1.028-.589 1.202a5.989 5.989 0 01-2.031.352 5.989 5.989 0 01-2.031-.352c-.483-.174-.711-.703-.59-1.202L5.25 4.971z" />
										</svg>
										<span
							...
							<div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
								<ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
									<Link :href="route('admin.docs.index')"
										class="mb-1 last:mb-0 block text-slate-400 hover:text-slate-200 transition duration-150 truncate"
										:class="(route().current('admin.docs.index')) && '!text-teal-300'">
									<span
						...
						<SidebarLinkGroup v-slot="parentLink" :activeCondition="route().current('admin.reports.*')">
							<a class="block text-slate-200 hover:text-white truncate transition duration-200 py-2"
								...
								<div class="flex items-center justify-between">
									<div class="flex items-center">
										<svg v-if="route().current('admin.reports.index')" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 text-teal-300">
							...
							<div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
								<ul class="pl-9 mt-1" :class="!parentLink.expanded && 'hidden'">
									...
									<Link :href="route('admin.reports.accounts.index')"
										class="mb-1 last:mb-0 block text-slate-400 hover:text-slate-200 transition duration-150 truncate"
										:class="(route().current('admin.reports.accounts.index')) && '!text-teal-300'">
									<span
										class="text-sm font-light lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">Accounts</span>
									</Link>
								</ul>
							</div>
						</SidebarLinkGroup>
