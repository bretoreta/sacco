...
<template>
    <AdminLayout title="Repayment Transactions Overview">
        <div class="py-6 md:py-12">
            <div class="mx-auto sm:px-6 lg:px-8">
                <div class="grid grid-cols-12 gap-5 px-4">
                    <div class="col-span-12 my-5">
                        <div class="py-3">
                            <h4 class="text-3xl font-bold text-gray-700">Repayment Transactions Overview</h4>
                        </div>
